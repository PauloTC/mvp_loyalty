      ...
      <div className="dl-px-5 md:dl-min-w-fit md:dl-w-2/5 md:dl-py-14 md:dl-px-[5.5rem] md:dl-flex md:dl-justify-center md:dl-items-center">
        <div className="md:dl-w-80">
          <div className="dl-grid dl-gap-6 dl-pt-8 dl-px-4 ">
            <a href="/" className="dl-flex dl-items-center dl-gap-2">
            ...
            <span className="dl-font-bold dl-font-alicorpSans dl-text-2xl dl-leading-[1.92rem] dl-text-[#202020]">
              Iniciar sesión
            </span>
          </div>
          <form className="dl-py-10  dl-px-4 dl-grid dl-gap-6">
            ...
            <DlButton block>Ingresar</DlButton>
            <DlCheckbox size="lg">Recuérdame</DlCheckbox>
            <a
              className="dl-text-link-blue"
              href="#"
